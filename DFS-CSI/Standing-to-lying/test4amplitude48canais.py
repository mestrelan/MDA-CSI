...
if __name__=="__main__":
    ...
    model = TransformerModel(input_size=48, output_size=1, num_heads=6, num_layers=2).to(device)#num_heads=8, num_layers=6
    ...
    listas_treinamento=train_model(model, train_loader, val_loader, criterion, optimizer, scheduler, device, 20)
